...
STEP 2: Define a graph using vector<vector<int>> g to store adjacency lists and vector<bool> v to track visited vertices.
...
Initializes a queue<int> q and pushes the starting vertex u.
...
## Output:
<img width="554" height="596" alt="{50BCFE61-1690-4FCE-B9F3-D0204C2A0A84}" src="https://github.com/user-attachments/assets/65cbe19b-e47d-48e1-ab6c-46124ab86420" />
