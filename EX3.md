...
STEP 2: Define a graph using vector<vector<int>> g and a vector<bool> v to track visited vertices.
...
Initializes queue<int> q and pushes starting vertex u.
...
## Output:
<img width="525" height="562" alt="{C676DDD0-1279-4DE9-A733-77E3F4EE24AE}" src="https://github.com/user-attachments/assets/6ca16f92-9ad8-4d55-95fe-d6f195582157" />
